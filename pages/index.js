...
import { getETHPriceINR, getWEIPriceInINR } from "../lib/getETHPrice";
import {
  Heading,
  useBreakpointValue,
  useColorModeValue,
      ...
      <main className={styles.main}>
        <Container py={{ base: "4", md: "12" }} maxW={"7xl"} align={"left"}>
          ...
          <Heading
            ...
            py={4}
          >
            Bring your ideas to life with the power of community and <br /> smart, secure crowdfunding 🤝{" "}
          </Heading>
        ...
        <Container py={{ base: "4", md: "12" }} maxW={"7xl"} id="howitworks">
          ...
          <SimpleGrid columns={{ base: 1, md: 3 }} spacing={10} py={8}>
            ...
            <Feature
              ...
              text={
                "The funds raised can be withdrawn directly to the recipient when the contributors approve of the Withdrawal Request."
              }
            />
          </SimpleGrid>
          <Divider marginTop="4" />
